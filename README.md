...
- **Per-item data** — Each item has a color, title, and value.
...
- **Legend** — Toggleable legend with colored swatches, aligned to the right on a 5/1 grid.
...
- **Contrast-aware** — Text colors automatically switch between black and white based on background luminance.
