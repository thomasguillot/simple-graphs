...
- **Legend** — Toggle on/off from the Chart toolbar. Side style (1/5 grid column on desktop) or Stack (horizontal). Has its own typography, colour, padding, border, and shadow controls. Stacks below the chart on mobile.
...
- **Contrast-aware text** — Text colour automatically switches between black and white based on background. Users can override with any colour.
